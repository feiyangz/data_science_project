...
company <- rep(NA, 100000)
location <- rep(NA, 100000)
industry <- rep(NA, 100000)
Python<-rep(NA, 100000)
R<-rep(NA, 100000)
SAS<-rep(NA, 100000)
SQL<-rep(NA, 100000)
Java<-rep(NA,100000)
Tableau<-rep(NA, 100000)
Spark<-rep(NA, 100000)
C<-rep(NA, 100000)
Perl<-rep(NA, 100000)
Excel<-rep(NA, 100000)
...
#In this project, I will only collect data from the first 200 pages.
url.1<- paste0("https://www.glassdoor.com/Job/data-scientist-jobs-SRCH_KO0,14_IP", 1:200, ".htm")

#get each sub urls

subpage.2 <- lapply(url.1, function(url.1) {
...
for(j in 1:length(subpage)){
  ...
  desc.1 <-subpage.1 %>% readLines(warn=FALSE)
